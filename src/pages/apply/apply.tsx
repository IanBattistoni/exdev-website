...
const [momazo, setMomazo] = useState("");
          ...
          <form id="miFormulario" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <textarea
                id="ayudantia"
                value={ayudantia}
                onChange={(e) => setAyudantia(e.target.value)}
                required
              />
            ...
            <div>
              ...
              <textarea
                id="unirse"
                value={unirse}
                onChange={(e) => setUnirse(e.target.value)}
                required
              />
            ...
            <div>
              ...
              <textarea
                id="nombresMas"
                value={nombresMas}
                onChange={(e) => setNombresMas(e.target.value)}
                required
              />
            ...
            <div>
              ...
              <textarea
                id="momazo"
                value={momazo}
                onChange={(e) => setMomazo(e.target.value)}
                required
              />
